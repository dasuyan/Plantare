...
fun rememberAppState(
  ...
  remember(scaffoldState, navController, snackbarManager, resources, coroutineScope) {
    PlantareAppState(scaffoldState, navController, snackbarManager, resources, coroutineScope)
  }
...
@ExperimentalMaterialApi
fun NavGraphBuilder.plantareGraph(appState: PlantareAppState) {
